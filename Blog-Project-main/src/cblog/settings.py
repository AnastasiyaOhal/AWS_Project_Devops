...
DATABASES = {
    'default': {
        ...
        'NAME': 'my_db', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': 'admin12345',
        'HOST': 'database-1.c2bbsyffxu6o.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'web-sitee' # please enter your s3 bucket name
